...
pub fn part1(input: &str) -> i64 {
    let (seeds, almanac) = parse_almanac_p1(input);
...
pub fn part2(input: &str) -> i64 {
    let (seeds, almanac) = parse_almanac_p2(input);
...
";
    ...
    fn check_ex_seed_to_soil(#[case] seed: i64, #[case] soil: i64) {
        let (_seeds, almanac) = parse_almanac_p1(EXAMPLE_INPUT);
...
fn parse_almanac_p1(input: &str) -> (Vec<i64>, Almanac) {
    let _ = input;
...
fn parse_almanac_p2(input: &str) -> (Vec<(i64, i64)>, Almanac) {
    let _ = input;
    ...
    if cfg!(test) {
        ...
        seeds = vec![
            (1310704671, 312415190),
            (1034820096, 106131293),
            (682397438, 30365957),
            (2858337556, 1183890307),
            (665754577, 13162298),
            (2687187253, 74991378),
            (1782124901, 3190497),
            (208902075, 226221606),
